...
<section class="container">
    <div class="teamCards">
        <?php foreach( $team as $i => $member ):
            ...
            ?>
            <a class="teamCards__item | intersect fadeIn" href="#<?= $modalId; ?>">
                <div class="teamCards__image">
                ...
                <div class="teamCards__info">
                    <div class="teamCards__name"><?= esc_html( $name ); ?></div>
                    <div class="teamCards__role"><?= esc_html( $role ); ?></div>
                </div>
            </a>
        <?php endforeach; ?>
    </div>
